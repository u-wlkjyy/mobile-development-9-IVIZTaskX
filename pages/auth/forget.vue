	...
	<view>
		<view class="main-box">
			<view class="main">
				...
				<view class="form-control">
					<label for="" class="input_name">新密码</label>
					<input type="password" class="input_control" v-model="new_password">
				</view>
				<view class="login" @click="loginEvent">重置密码</view>

				<view class="option">
					<view class="code-login" @click="toBackLogin">返回登录</view>
